  ...
  return (
    ...
    >
      ...
      <button
        ...
        style={{
          backgroundColor: filterType === 'owner' ? '#007AFF' : undefined,
          borderColor: filterType === 'owner' ? '#007AFF' : undefined,
      ...
      <button
        ...
        style={{
          backgroundColor: filterType === 'ctv' ? '#FF9500' : undefined,
          borderColor: filterType === 'ctv' ? '#FF9500' : undefined,
